...
const data = [
    {
        ...
        data: [
            {q: "Clustered Column"},
            {q: "Stacked Column"},
            {q: "100% Stacked Column"},
            {q: "3-D Clustered Column"},
            {q: "3-D Stacked Column"},
            {q: "3-D 100% Stacked Column"},
            {q: "3-D Column"},
            {q: "Line"},
            {q: "Stacked Line"},
            {q: "100% Stacked Line"},
            {q: "Line with Markers"},
            {q: "Stacked Line with Markers"},
            {q: "100% Stacked Line with Markers"},
            {q: "3-D Line"},
            {q: "Pie"},
            {q: "3-D Pie"},
            {q: "Pie of Pie"},
            ...
            {q: "3-D Clustered Bar"},
            {q: "3-D Stacked Bar"},
            {q: "3-D 100% Stacked Bar"},
            {q: "Area"},
            {q: "Stacked Area"},
            {q: "100% Stacked Area"},
            {q: "3-D Area"},
            {q: "3-D Stacked Area"},
            {q: "3-D 100% STacked Area"},
            {q: "Scatter"},
            {q: "Scatter with Smooth Lines and Markers"},
            {q: "Scatter with Smooth Lines"},
            {q: "Scatter with Straight Lines and Markers"},
            {q: "Scatter with Straight Lines"},
            {q: "Bubble"},
            {q: "Bubble 3-D"},
            {q: "Stock High-Low-Close"},
            {q: "Stock Open-High-Low-Close"},
            {q: "Stock Volume-High-Low-Close"},
            {q: "Stock Vloume-Open-High-Low-Close"},
            {q: "3-D Surface"},
            {q: "Wireframe 3-D Surface"},
            {q: "Contour"},
            {q: "WireFrame Contour"},
            {q: "Radar"},
            {q: "Radar with Markers"},
            {q: "Filled Radar"},
            {q: "Treemap"},
            {q: "Sunburst"},
            {q: "Histogram"},
        ...
        data: [
            {
                ...
                data: [
        ...
        
                    {
                        ...
                        data: [
                            {q: "Primary Horizontal", again: [0,1]},
                            {q: "Primary Vertical", again: [0,1]}
                        ]
                    },
        ...
        
                    {
                        ...
                        data: [
                            {q: "Primary Major Vertical", again: [0,1,2,3]},
                            {q: "Primary Major Horizontal", again: [0,1,2,3]},
                            {q: "Primary Minor Vertical", again: [0,1,2,3]},
                            {q: "Primary Minor Horizontal", again: [0,1,2,3]}
                        ]
                    },
        ...
        
                    {
                        ...
                        data: [
                            {q: "Linear", again: [0,1,2,3]},
                            {q: "Exponential", again: [0,1,2,3]},
                            {q: "Linear Forcast", again: [0,1,2,3]},
                            {q: "Moving Average", again: [0,1,2,3]}
                        ]
                    }
                ]
            },
